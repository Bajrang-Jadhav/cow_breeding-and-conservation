                    ...
                    <div class="service-item d-flex h-100">
                        ...
                        <div class="service-text p-5 pt-0">
                            ...
                            <h5 class="mb-3">Best Animal Selection</h4>
                                <p class="mb-4">Select animals that are free from diseases and exhibit good reproductive performance
                                    <br>
                                    Evaluate the animal's physical structure for soundness and functionality.
                                    <br>
                                    Indigenous breeds often exhibit greater resilience to local conditions, while exotic breeds may offer higher production potential..</p>
                                <a class="btn btn-square rounded-circle" href="animalselection.php"><i class="bi bi-chevron-double-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 pt-5 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item d-flex h-100">
                        ...
                        <div class="service-text p-5 pt-0">
                            ...
                            <p class="mb-4">Preserving indigenous cow breeds is essential for maintaining genetic diversity and adaptability to local environments.   
                                <br>
                                Conservation efforts involve establishing breeding programs, maintaining breed registries, and promoting the use of native breeds.</p>
                            <a class="btn btn-square rounded-circle" href="breedvet.php"><i class="bi bi-chevron-double-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 pt-5 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item d-flex h-100">
                        ...
                        <div class="service-text p-5 pt-0">
                            ...
                            <p class="mb-4">Semen from a high-quality bull is collected and injected into a cow’s reproductive tract.
                ...
                <div class="col-lg-7 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="owl-carousel testimonial-carousel">
                        <div class="testimonial-item">
                            ...
                            <p class="fs-5">Farmers are increasingly receptive to technologies that improve efficiency and animal welfare.
                                Tools like AI-powered monitoring systems (for calving, health, etc.) are seen as valuable time-savers..</p>
                            <h5>Arvind Shaha</h5>
                        ...
                        <div class="testimonial-item">
                            ...
                            <p class="fs-5"> Emphasis on Animal Welfare:
                                Consumers and farmers alike are placing greater importance on ethical treatment of animals.
                        ...
                        <div class="testimonial-item">
                            ...
                            <p class="fs-5">There's a growing awareness of the environmental impact of agriculture.
                                Practices that promote sustainable cow breeding and reduce waste are gaining popularity..</p>
                            <h5>Vinod Meheta</h5>
                            <span class="text-primary">Scientist</span>
                        </div>
                        <div class="testimonial-item">
                            <img class="img-fluid mb-3" src="img/testimonial-4.jpg" alt="">
                            <p class="fs-5"> There are also concerns about maintaining the genetic diversity of indigenous breeds in the face of widespread crossbreeding.People are happy with the ability to get alerts on their smart phones.</p>
                            <h5>Rani Varma</h5>
...
>>>>>>> 9ea2d79d1ed5fa5b1e15d4f6435ea3bcbd595c95:index.php
</html>