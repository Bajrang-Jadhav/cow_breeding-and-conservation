                    ...
                    <div class="service-item d-flex h-100">
                        ...
                        <div class="service-text p-5 pt-0">
                            ...
                            <p class="mb-4"> Genetic Traits & Breed Selection Physical Characteristics
                                            Body Structure: Strong legs, wide chest, and good body condition score (BCS) (Ideal: 4-6 on a 9-point scale).
                ...
                <div class="col-lg-4 col-md-6 pt-5 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item d-flex h-100">
                        ...
                        <div class="service-text p-5 pt-0">
                            ...
                            <p class="mb-4">Breeding is a key factor in dairy farming as it determines milk yield, fertility, and overall cattle health.
                                Veterinary Care:
                    ...
                    <div class="service-item d-flex h-100">
                        ...
                        <div class="service-text p-5 pt-0">
                            ...
                            <p class="mb-4">Natural Breeding: Cows mate naturally with a bull to conceive.
                                Artificial Insemination (AI): A controlled method where high-quality bull semen is artificially introduced into the cow's reproductive system to improve genetic traits.</p>
                            <a class="btn btn-square rounded-circle" href="types.php"><i class="bi bi-chevron-double-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 pt-5 wow fadeInUp" data-wow-delay="0.3s">
                ...
                <div class="col-lg-4 col-md-6 pt-5 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item d-flex h-100">
                        ...
                        <div class="service-text p-5 pt-0">
                            ...
                            <a class="btn btn-square rounded-circle" href="artificial.php"><i class="bi bi-chevron-double-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 pt-5 wow fadeInUp" data-wow-delay="0.3s">
